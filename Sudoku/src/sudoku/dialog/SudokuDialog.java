...
public class SudokuDialog extends JFrame {
    ...
    private final static String IMAGE_DIR = "/Users/nicholasvenecia/Documents/Eclipse/Sudoku/src/image/";
    ...
    private void numberClicked(int number) throws IOException {
        ...
        else if(!board.checkBoard(number)){
            showMessage("Number conflict.");
            boardPanel.repaint();
        }
    ...
    private void newClicked(int size) {
    	...
    	int answer = JOptionPane.showConfirmDialog(frame, "Play a new game?");
    	if (answer == JOptionPane.YES_OPTION) {
    		//create new board with the new size of the button
